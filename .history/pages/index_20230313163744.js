  ...
  return (
    ...
    <main>
        <div className={styles.imagecontainer}>
          <h1>
            <FormattedMessage id="page.home.mainpagetitle"/>
          </h1>
        ...
        <div className={styles.side}>
          ...
          <li className={styles.links}><a href="/">
        ...
        <h2>
          ...
          <p>
          <FormattedMessage id="page.home.format"/>
          </p>
          <p>
          <FormattedMessage id="page.home.length"/>
         </p>
         <p>
         <FormattedMessage id="page.home.start"/>
        </p>
        <p>
         <FormattedMessage id="page.home.location"/>
        </p>
        <p>
         <FormattedMessage id="page.home.tuition"/>
        </p>
        <p>
         <FormattedMessage id="page.home.international"/>
        </p>
        <br></br>
        <h4 className={styles.media2}>
        <FormattedMessage id="page.home.media"/>
         </h4>
